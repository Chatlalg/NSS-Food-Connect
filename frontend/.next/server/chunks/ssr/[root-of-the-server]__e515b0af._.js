...
const SignIn = ()=>{
    ...
    const onSubmit = async (data)=>{
        ...
        // setUser(jwt)
        // if(!user) throw new Error("Authentication failed: token not found in store")
        // router.replace(user?.userType===0 ? "/admin/donations" : "/volunteers/donate")
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e515b0af._.js.map