...
const config = {
    apiUrl: ("TURBOPACK compile-time value", "http://localhost:9000") || 'http://localhost:9000',
...
__turbopack_context__.s({
    "adminAPI": (()=>adminAPI),
    "authAPI": (()=>authAPI),
    "decodeUserFromToken": (()=>decodeUserFromToken),
...
const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"].apiUrl,
...
const adminAPI = {
    ...
    approveDonation: async ({ donationid, credits })=>{
        return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:9000")}/admin/approve`, {
            donationid,
            credits
        }, {
            withCredentials: true
    ...
    rejectDonation: async ({ donationid })=>{
        return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:9000")}/admin/reject`, {
            donationid
        }, {
            withCredentials: true
        });
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initializeAuth = ()=>{
            try {
                const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTokenFromCookies"])();
                if (token) {
                    const decodedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decodeUserFromToken"])(token);
                    if (decodedUser) {
                        setUser(decodedUser);
                    }
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5838d8f5._.js.map